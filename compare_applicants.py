...
def get_skill_match(applicant, job):
    ...
    llm = OpenAI(openai_api_key="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", temperature=0.0, model_name="text-davinci-003", max_tokens="2000")
...
def get_workExperience_and_Degree(applicant):
    ...
    embeddings = OpenAIEmbeddings(openai_api_key="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")
    knowledge_base = FAISS.from_texts(resume_chunks, embeddings)
    llm = OpenAI(openai_api_key="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", temperature=0.0,
